...
# Provide your access token and key, and consumer token and key as the global variables declared here.
TOKEN_KEY = "4851188327-IlVr0KYJDslHqkTKeyOSgMAytxanPynllzfd6nQ"
TOKEN_SECRET = "PEXc8YmhsFw4KA9752oj3ki0LaV4ZiMcGeNKABU5nOnvA"
CONSUMER_KEY = "AO0M4UOlCVWK8HFQza8eE5dcZ"
CONSUMER_SECRET = "j77779NrBvVvUeBmdiHq1Y8wui0qlbC89zQVJPKbSj3r7CuYbc"
...
def read_total_list( in_filename ):
    ...
    fp = open( in_filename, 'r' ) # Defconn4: Changed 'rb' to read binary data to 'r'.
...
def pull_data(id, raw_dir) :
    ...
    with open(raw_dir + id + '.json', 'w') as outfile: # Defconn4: Changed 'wb' to write binary data to 'w'.
...
def download_tweets( fetch_list, raw_dir ):
    ...
    # Defconn4: New rate limit: 180 tweets per 15 minutes => 720 tweets per hour.
    #           This means it should no longer take ~44 hours to download all tweets.
    #           Found here for 'GET: search/tweets': https://developer.twitter.com/en/docs/twitter-api/v1/rate-limits
    max_tweets_per_hr  = 40000 # Defconn4: Changed 125 to 720
...
def parse_tweet_json( filename ):
    ...
    fp = open( filename, 'r' ) # Defconn4: Changed 'rb' to 'r'
...
def build_output_corpus( out_filename, raw_dir, total_list ):
    ...
    fp = open( out_filename, 'w' ) # Defconn4: Changed 'wb' to 'w'
